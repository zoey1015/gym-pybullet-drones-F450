...
class DSLPIDControl(BaseControl):
    ...
    def __init__(self,
        ...
        if self.DRONE_MODEL != DroneModel.CF2X and self.DRONE_MODEL != DroneModel.CF2P and self.DRONE_MODEL != DroneModel.CF2Xr:
            print("[ERROR] in DSLPIDControl.__init__(), DSLPIDControl requires DroneModel.CF2X or DroneModel.CF2P")
            exit()
        self.P_COEFF_FOR = np.array([0.4, 0.4, 1.0])
        self.I_COEFF_FOR = np.array([.02, .02, .1])
        self.D_COEFF_FOR = np.array([.2, .2, .3])
        self.P_COEFF_TOR = np.array([8000., 8000., 4000.])
        self.I_COEFF_TOR = np.array([300, 300, 300.])
        self.D_COEFF_TOR = np.array([2500., 2500., 1500.])
        self.PWM2RPM_SCALE = 11.0
        self.PWM2RPM_CONST = -11000.0
        self.MIN_PWM = 1000
        self.MAX_PWM = 2000
        ...
        elif self.DRONE_MODEL == DroneModel.CF2Xr:
            self.MIXER_MATRIX = np.array([
                                    [-.5, -.5, -1],
                                    [-.5,  .5,  1],
                                    [.5, .5, -1],
