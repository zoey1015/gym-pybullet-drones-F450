...
DEFAULT_DRONES = DroneModel("cf2x-r")
...
def run(
    ...
    INIT_XYZS = np.array([[0.0, 0.0, 0.3] for i in range(num_drones)])
    ...
    if drone in [DroneModel.CF2X, DroneModel.CF2P,DroneModel.CF2Xr]:
